...
public class frmAdicionarUsuario extends javax.swing.JDialog {
     ...
     */
    public frmAdicionarUsuario(java.awt.Frame parent, boolean modal, UsuarioDAO usuarioDAO, frmUsuario control) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setTitle("Adicionar Novo Usu�rio");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmAdicionarUsuario dialog = new frmAdicionarUsuario(new javax.swing.JFrame(), true, new UsuarioDAO(),null);
